...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawable1 = res1.getDrawable(R.drawable.moto, getTheme());
        ...
        drawable2 = res2.getDrawable(R.drawable.serviciocliente, getTheme());
        ...
        drawable3 = res3.getDrawable(R.drawable.musica, getTheme());
